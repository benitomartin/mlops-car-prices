# Define an Elastic Container Registry (ECR) repository
...
## Create a null_resource to build and push the Docker image to the ECR repository
...
# Use a data source to fetch information about the ECR image
...
# Output the URI of the Docker image in the ECR repository
output "image_uri" {
